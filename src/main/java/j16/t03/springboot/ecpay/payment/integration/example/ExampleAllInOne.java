package j16.t03.springboot.ecpay.payment.integration.example;
...
import j16.t03.springboot.ecpay.payment.integration.AllInOne;
...
public class ExampleAllInOne {
	...
	//付款方式
	public static String genAioCheckOutALL(String ordTotal,Integer custId){
